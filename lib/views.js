  ...
  var search = new Vue({
    ...
    created: function() {
      ...
      setInterval(function() {
        ...
        for (var key in engine.dht._router._buckets) {
          engine.dht._router._buckets[key].getContactList().map(function(contact) {
    ...
    methods: {
      ...
      resolve: function(e) {
        ...
        engine.resolve(this.key, onComplete).on('status', function(status) {
          file.status = status;
        });
